...
},
{
  ...
  },
  {
    ...
    "history": [
      "Планы по строительству станции были озвучены в начале 1980-х годов и вызвали протесты более миллиона жителей Гонконга, обеспокоенных безопасностью.",
      "Строительство первого энергоблока началось 7 августа 1987 года, а второго — 7 апреля 1988 года.",
      "Первый энергоблок был физически запущен 28 июля 1993 года, подключен к сети 31 августа 1993 года и введён в коммерческую эксплуатацию 1 февраля 1994 года.",
      "Второй энергоблок достиг критичности 21 января 1994 года, был подключен к сети 7 февраля 1994 года, а коммерческая эксплуатация началась 6 мая 1994 года.",
      "После аварии на Фукусиме-1 в 2011 году эксплуатирующая организация CGNPC провела переоценку безопасности и внедрила ряд усовершенствований, включая установку дополнительных дизель-генераторов и мобильных насосов."
    ],
    "facts": [
      "Это вторая атомная электростанция в истории Китая и первая, построенная с крупным иностранным участием (французская компания Framatome).",
      "Более 70% электроэнергии, вырабатываемой станцией, закупает Гонконг. Это делает Даявань ключевым элементом энергобезопасности региона.",
      "Во время строительства в 1987 году была обнаружена пропажа 316 стальных арматурных стержней, что потребовало дополнительного армирования конструкции и ужесточения контроля на площадке.",
      "В октябре 2010 года на первом блоке был зафиксирован инцидент уровня «1» по шкале INES, связанный с обнаружением течи борной кислоты из трубопровода первого контура. Утечка была устранена без последствий для персонала и окружающей среды.",
      "На площадке станции проводится международный физический эксперимент Daya Bay Reactor Neutrino Experiment по изучению нейтрино. В 2012 году в рамках этого эксперимента было сделано важное открытие, связанное с параметрами нейтринных осцилляций.",
      "С 2006 года станция открыта для посещения туристами (в формате экскурсионного центра), где посетители могут получить информацию о безопасности и экологическом мониторинге."
    ]
  },
  {
    "id": 3601,
    ...
    "history": [
      "АЭС Линьао была построена как расширение крупнейшей в Китае ядерной энергетической базы «Даявань». Строительство первых двух блоков началось в 1997 году.",
      "Блоки 1 и 2 были введены в эксплуатацию в 2002 году, что позволило увеличить поставки электроэнергии в Гонконг и Гуандун.",
      "Строительство второй очереди (блоки 3 и 4) стартовало в 2005 году. Это был первый проект в Китае, реализованный с использованием технологии CPR-1000, представляющей собой локализованную версию французского M310.",
      "Блоки 3 и 4 были введены в эксплуатацию в 2010 и 2011 годах соответственно, что ознаменовало переход Китая к серийному строительству атомных блоков по собственной лицензии.",
      "После аварии на АЭС «Фукусима-1» в Японии в 2011 году, как и соседняя АЭС Даявань, была подвергнута переоценке безопасности с внедрением ряда модернизаций, включая усиление защиты от запроектных аварий."
    ],
    "facts": [
      "АЭС Линьао расположена непосредственно рядом с АЭС Даявань (расстояние между площадками около 1 км), и вместе они образуют крупнейшую в Китае базу атомной энергетики площадью 10 кв. км.",
      "Вторая очередь станции (блоки 3 и 4) знаменует переход от французских реакторов M310 к локализованной китайской модели CPR-1000, что стало важным этапом в развитии национальных ядерных технологий. CPR-1000 впоследствии стал основой для многих АЭС Китая.",
      "Блоки Линьао-3 и Линьао-4 стали первыми в Китае, спроектированными с использованием системы цифрового управления (DCS) собственной разработки, что повысило надежность управления технологическими процессами."
    ]
  },
  {
    "id": 3602,
    ...
    "history": [
      "Строительство первого энергоблока АЭС Ниндэ началось в феврале 2008 года. Станция стала первой АЭС в провинции Фуцзянь.",
      "Первый блок был подключен к сети в декабре 2012 года и введен в коммерческую эксплуатацию в апреле 2013 года.",
      "Блоки 2, 3 и 4 были введены в эксплуатацию в 2014, 2015 и 2016 годах соответственно, что сделало станцию важным источником энергии для быстрорастущего региона.",
      "В 2024 году началось строительство пятого блока по технологии HPR1000 (Hualong One), что знаменует новый этап развития площадки с использованием реакторов поколения III+."
    ],
    "facts": [
      "АЭС Ниндэ стала первой атомной станцией в Китае, которая начала коммерческую эксплуатацию в провинции Фуцзянь, способствуя снижению зависимости региона от угольной генерации.",
      "Станция изначально проектировалась с учетом сейсмических рисков, так как расположена в зоне возможных землетрясений. Блоки CPR-1000 были адаптированы к местным геологическим условиям.",
      "Пятый блок (HPR1000) станет одним из первых, строящихся после возобновления одобрения новых проектов в Китае после временной паузы в начале 2020-х годов."
    ]
  },
  {
    "id": 3603,
    ...
    "history": [
      "Проект был одобрен в 2004 году как часть стратегии по внедрению в Китае передовых зарубежных реакторных технологий третьего поколения.",
      "Заливка первого бетона для блока 1 состоялась в апреле 2009 года. Строительство столкнулось с задержками из-за сложности конструкции AP1000 и необходимости доработок.",
      "В 2018 году блоки 1 и 2 стали первыми в мире реакторами AP1000, достигшими коммерческой эксплуатации, опередив аналогичные проекты в США.",
      "В 2022 году началось строительство третьего и четвертого блоков, но уже по китайской локализованной версии проекта — CAP1000."
    ],
    "facts": [
      "Саньмэнь стала пилотной площадкой для технологии Westinghouse AP1000. Ее успешный запуск в 2018 году позволил Китаю освоить и затем локализовать эту технологию под названием CAP1000.",
      "Реакторы AP1000 на Саньмэнь имеют пассивную систему безопасности, которая не требует вмешательства оператора или использования внешнего электропитания для отвода остаточного тепловыделения в течение 72 часов после аварии.",
      "Строительство первых двух блоков обошлось более чем в 40 миллиардов юаней (около 6 миллиардов долларов США), что сделало проект одним из самых дорогостоящих в истории китайской атомной энергетики."
    ]
  },
  {
    "id": 3604,
    ...
    "history": [
      "Предварительные работы на площадке начались в 2010 году, но активное строительство стартовало позже из-за корректировки планов и выбора технологической платформы.",
      "В 2018 году было подписано межправительственное соглашение с Россией о строительстве двух блоков с реакторами ВВЭР-1200 (блоки 3 и 4).",
      "Церемония заливки первого бетона для блока 3 (российского) состоялась в мае 2021 года, для блока 4 — в мае 2022 года.",
      "Строительство блоков 1 и 2 с китайскими CAP1000 началось в 2023 и 2024 годах соответственно, что делает Сюйдапу уникальной площадкой с двумя разными технологиями поколения III+."
    ],
    "facts": [
      "Это единственная атомная станция в Китае, где одновременно реализуются проекты с использованием реакторов российского дизайна (ВВЭР-1200) и китайского дизайна на основе американской лицензии (CAP1000).",
      "Российские блоки строятся в рамках контракта «под ключ», что подразумевает полный цикл поставки оборудования, включая ядерное топливо для первоначальной загрузки.",
      "АЭС расположена на побережье Бохайского залива, в районе с высокой сейсмической активностью, поэтому при проектировании были применены специальные инженерные решения для защиты от землетрясений и цунами."
    ]
  },
  {
    "id": 3605,
    ...
    "history": [
      "Планирование площадки началось в середине 2000-х годов как часть расширения ядерной энергетики в провинции Гуандун.",
      "Официальное начало строительства (заливка первого бетона) блока 1 состоялось в декабре 2019 года, блока 2 — в октябре 2020 года.",
      "Строительство ведется с использованием стандартизированного проекта HPR1000, что позволяет сократить сроки и стоимость строительства.",
      "Проект изначально назывался «Хойэоу» (Hui'ao), но позже получил маркетинговое имя «Тайпинлин» (Taipingling)."
    ],
    "facts": [
      "Тайпинлин станет первой станцией, построенной по унифицированному проекту HPR1000 (Hualong One) с использованием китайской цепочки поставок без значимых иностранных компонентов.",
      "Станция расположена в непосредственной близости от крупных промышленных центров дельты Жемчужной реки, что позволит снизить нагрузку на угольные электростанции региона.",
      "Для повышения безопасности реакторы HPR1000 на Тайпинлин оснащены двойной защитной оболочкой (containment), способной выдерживать прямое попадание крупного коммерческого авиалайнера."
    ]
  },
  {
    "id": 3606,
    ...
    "history": [
      "Фанцзяшань является третьей очередью крупнейшей ядерной базы Циньшань. Строительство блока 1 началось в декабре 2008 года, блока 2 — в июле 2009 года.",
      "Первый блок был подключен к сети в декабре 2014 года и введен в коммерческую эксплуатацию в январе 2015 года.",
      "Второй блок был подключен к сети в январе 2015 года и начал коммерческую работу в феврале 2015 года.",
      "Станция была построена в рекордные сроки для проектов CPR-1000, что стало результатом накопленного опыта на предыдущих площадках."
    ],
    "facts": [
      "Фанцзяшань является частью единой площадки Циньшань, которая включает в себя 9 блоков (Циньшань, Фанцзяшань и Циньшань-2), что делает ее одной из крупнейших ядерных площадок в мире по количеству блоков.",
      "Станция расположена на побережье залива Ханчжоу, недалеко от крупных городов Шанхай и Ханчжоу, обеспечивая их электроэнергией.",
      "На площадке Фанцзяшань впервые в Китае была внедрена система управления строительством на основе BIM (информационного моделирования зданий)."
    ]
  },
  {
    "id": 3607,
    ...
    "history": [
      "Строительство первого блока началось в июле 2010 года, второго — в декабре 2010 года. Изначально оба блока проектировались как CPR-1000.",
      "Блок 1 был введен в коммерческую эксплуатацию в январе 2016 года, блок 2 — в октябре 2016 года.",
      "Строительство третьего и четвертого блоков по технологии HPR1000 стартовало в декабре 2015 года и декабре 2016 года соответственно, несмотря на временную паузу в одобрении новых проектов после Фукусимы.",
      "Блок 3 был подключен к сети в январе 2022 года и стал первым в мире реактором HPR1000 (Hualong One), введенным в эксплуатацию в составе CGN (China General Nuclear Power Group).",
      "Блок 4 был введен в коммерческую эксплуатацию в 2024 году, завершив формирование первой очереди станции."
    ],
    "facts": [
      "Фанчэнган — первая атомная электростанция в Гуанси-Чжуанском автономном районе, регионе, который ранее полностью зависел от угольной и гидрогенерации.",
      "Блоки 3 и 4 являются флагманскими проектами CGN по продвижению технологии HPR1000 (Hualong One), которая позиционируется как основной экспортный продукт китайской атомной энергетики.",
      "Станция расположена в непосредственной близости от Вьетнама, что подчеркивает региональное значение проекта в рамках энергетического сотрудничества в Юго-Восточной Азии."
    ]
  },
  {
    "id": 3608,
    ...
    "history": [
      "Строительство первых четырех блоков велось с 2008 по 2012 годы. Первый блок был введен в эксплуатацию в 2014 году.",
      "Блоки 5 и 6, строительство которых началось в 2015 году, стали первыми в мире блоками, построенными по объединенной китайской технологии Hualong One (HPR1000), разработанной CNNC.",
      "Блок 5 был подключен к сети в ноябре 2020 года, став первым в мире введенным в эксплуатацию реактором Hualong One.",
      "Блок 6 начал коммерческую эксплуатацию в январе 2022 года, что сделало Фуцин одной из крупнейших АЭС Китая с шестью действующими блоками."
    ],
    "facts": [
      "Фуцин стала первой в мире станцией, где был введен в эксплуатацию реактор Hualong One (блок 5), что стало важным этапом в программе технологического суверенитета Китая в ядерной сфере.",
      "Станция расположена в провинции Фуцзянь, которая активно развивает атомную энергетику для снижения выбросов углерода и замещения угольной генерации.",
      "Общая установленная мощность АЭС Фуцин (5438 МВт) сопоставима с мощностью крупнейших ГЭС мира, что делает ее одним из ключевых энергетических объектов юго-восточного Китая."
    ]
  },
  {
    "id": 3609,
    ...
    "history": [
      "Строительство первых двух блоков AP1000 началось в сентябре 2009 года и было частью первоначальной волны проектов AP1000 в Китае (вместе с Саньмэнь).",
      "В 2018 году, после многолетних задержек, связанных с доработкой технологии, блоки 1 и 2 были введены в коммерческую эксплуатацию.",
      "В 2022–2023 годах началось строительство третьего и четвертого блоков, но уже по локализованной китайской версии — CAP1000.",
      "Станция стала важным источником не только электроэнергии, но и тепла: в 2021 году Хайян запустила первую в Китае систему централизованного отопления на остаточном ядерном тепле."
    ],
    "facts": [
      "АЭС Хайян является первой в мире станцией, которая обеспечивает централизованное теплоснабжение города за счет энергии атомной станции (пилотный проект был запущен в 2021 году, охватив более 1 млн кв. метров жилья).",
      "Хайян и Саньмэнь стали основой для локализации технологии AP1000. На основе опыта их эксплуатации был создан китайский проект CAP1000.",
      "Станция расположена в провинции Шаньдун, крупнейшем энергопотребляющем регионе Китая, что делает ее критически важной для снижения углеродного следа региона."
    ]
  },
  {
    "id": 3610,
    ...
    "history": [
      "Исследования и разработка быстрых реакторов в Китае ведутся с 1960-х годов. CEFR (20 МВт) был построен как экспериментальный прототип в Пекине в 2010 году.",
      "Проект CFR-600 был официально одобрен в 2015 году как следующий этап перехода к коммерческим быстрым реакторам большой мощности.",
      "Заливка первого бетона для первого блока CFR-600 состоялась в декабре 2017 года. Это первый в мире быстрый реактор большой мощности, строящийся в коммерческом масштабе.",
      "Строительство второго блока началось в декабре 2020 года."
    ],
    "facts": [
      "CFR-600 — это натриевый быстрый реактор (с жидкометаллическим теплоносителем), который предназначен для замыкания ядерного топливного цикла. Он может использовать не только уран-235, но и уран-238, а также переработанное ядерное топливо.",
      "Проект Сяпу является ключевым элементом стратегии Китая по достижению самообеспеченности ядерным топливом и уменьшению объема радиоактивных отходов.",
      "Реактор CFR-600 является одним из крупнейших быстрых реакторов в мире. Его успешный запуск позволит Китаю выйти в лидеры в области технологий IV поколения."
    ]
  },
  {
    "id": 3611,
    ...
    "history": [
      "Строительство первой очереди (блоки 1–4) началось в 2007–2009 годах. Это был первый крупный ядерный проект на северо-востоке Китая.",
      "Первые два блока были введены в эксплуатацию в 2013 году, что позволило значительно снизить зависимость региона от угольной энергетики.",
      "Строительство второй очереди (блоки 5–6) стартовало в 2015 году с использованием усовершенствованной версии ACPR-1000.",
      "Блоки 5 и 6 были введены в эксплуатацию в 2021 и 2022 годах соответственно, завершив формирование станции общей мощностью более 5,5 ГВт."
    ],
    "facts": [
      "Хунъяньхэ — первая атомная станция на северо-востоке Китая, регионе, который традиционно сильно зависел от угля и испытывал проблемы с экологией из-за смога.",
      "Блоки 5 и 6 стали первыми в Китае, построенными по проекту ACPR-1000, который является эволюционным развитием CPR-1000 с улучшенными показателями безопасности и экономичности.",
      "Станция расположена на побережье Бохайского залива, недалеко от города Далянь, и является важным элементом энергоснабжения Ляодунского полуострова."
    ]
  },
  {
    "id": 3612,
    ...
    "history": [
      "Строительство первого блока (Циньшань-1) началось в 1985 году и стало символом начала китайской ядерной энергетики. Блок был полностью спроектирован и построен китайскими специалистами.",
      "Первый блок был подключен к сети в декабре 1991 года, что сделало Китай седьмой страной в мире, обладающей собственной атомной станцией.",
      "Вторая очередь (блоки 2-5) строилась с 1996 по 2011 год с использованием реакторов CNP-600, представляющих собой развитие технологий, полученных по французской лицензии.",
      "Третья очередь (блоки 6-7) была построена по канадской технологии CANDU-6 в рамках контракта с AECL. Строительство началось в 1998 году, коммерческая эксплуатация — в 2002–2003 годах."
    ],
    "facts": [
      "Циньшань является единственной в мире атомной станцией, на которой одновременно эксплуатируются реакторы PWR (под давлением) и PHWR (тяжеловодные) разных поколений: CNP-300, CNP-600 и CANDU-6.",
      "Блоки CANDU-6 (Циньшань-3) были адаптированы для использования топлива, производимого в Китае, и обладают высокой эффективностью использования природного урана.",
      "Циньшань-1 (310 МВт) был первым коммерческим атомным блоком, разработанным в Китае без прямой иностранной помощи. Он стал базой для создания серии CNP (China Nuclear Power)."
    ]
  },
  {
    "id": 3613,
    ...
    "history": [
      "Строительство первых двух блоков (CNP-600) началось в 2010 году. Они стали первыми атомными блоками на острове Хайнань.",
      "Блок 1 был введен в эксплуатацию в декабре 2015 года, блок 2 — в августе 2016 года.",
      "В 2021 году началось масштабное расширение: заливка бетона для блоков 3 и 4 (HPR1000), а также для первого в мире коммерческого наземного малого модульного реактора ACP100 (Linglong One)."
    ],
    "facts": [
      "Чанцзян — единственная атомная станция на острове Хайнань, который позиционируется как «экологически чистая провинция». Работа станции позволила отказаться от строительства новых угольных ТЭС на острове.",
      "На Чанцзян реализуется уникальный проект по строительству демонстрационного блока ACP100 (Linglong One) — первого в мире коммерческого наземного малого модульного реактора (SMR) мощностью 125 МВт. Это пилотный проект для будущего экспорта SMR.",
      "Станция расположена в тропическом климате, что потребовало разработки специальных решений по системам охлаждения и защите от тайфунов."
    ]
  },
  {
    "id": 3614,
    ...
    "history": [
      "Подготовительные работы на площадке начались в 2008 году, но официальное одобрение и старт строительства первого блока состоялись в октябре 2019 года.",
      "Строительство второго блока началось в сентябре 2020 года.",
      "В 2024 году началось строительство третьего и четвертого блоков, что сделало Чжанчжоу крупнейшей строящейся площадкой HPR1000 в Китае."
    ],
    "facts": [
      "Чжанчжоу станет первой в мире атомной станцией, на которой будут эксплуатироваться четыре блока HPR1000 (Hualong One) в рамках одной очереди строительства, что позволит достичь эффекта масштаба.",
      "Проект Чжанчжоу реализуется с максимальной степенью локализации: более 90% оборудования производится китайскими компаниями.",
      "Станция расположена на побережье Тайваньского пролива и, наряду с Фуцин и Ниндэ, формирует мощный ядерный кластер в провинции Фуцзянь."
    ]
  },
  {
    "id": 3615,
    ...
    "history": [
      "Проект HTR-PM (высокотемпературный газоохлаждаемый реактор) разрабатывался с 2000-х годов как флагманский проект в рамках программы IV поколения.",
      "Строительство HTR-PM началось в 2012 году. В 2021 году он был подключен к сети, став первым в мире коммерческим высокотемпературным газоохлаждаемым реактором.",
      "Строительство блоков CAP1400 (блоки 2 и 3 в списке) началось в 2019–2020 годах. Это увеличенная до 1500 МВт версия AP1000, разработанная в Китае.",
      "В 2024 году началось строительство четвертого блока (HPR1000), что расширяет технологический микс площадки."
    ],
    "facts": [
      "Шидаовань HTR-PM — первый в мире коммерческий высокотемпературный газоохлаждаемый реактор (HTGR) с шаровой засыпкой. Он обладает уникальной пассивной безопасностью: ядерное топливо выдерживает температуры до 1600°C без расплавления.",
      "CAP1400 — это самый мощный коммерческий реактор, разработанный в Китае (1500 МВт). Он является развитием технологии AP1000, адаптированной к китайским стандартам и условиям эксплуатации.",
      "На площадке Шидаовань представлены три различные технологии поколения III/IV: HTGR, CAP1400 и HPR1000, что делает ее уникальным научно-техническим полигоном мировой атомной энергетики."
    ]
  },
  {
    "id": 3616,
    ...
    "history": [
      "Разработка CEFR началась в 1990-х годах в Китайском институте атомной энергии (CIAE) при поддержке российских специалистов (на основе опыта БН-600).",
      "Строительство реактора велось с 2000 по 2010 год. Физический пуск состоялся в июле 2010 года.",
      "В 2011 году реактор был подключен к сети, став первым в Китае быстрым реактором, вырабатывающим электроэнергию.",
      "На протяжении 2010-х годов CEFR использовался для проведения экспериментов по наработке топлива, материаловедению и отработке технологий замкнутого цикла."
    ],
    "facts": [
      "CEFR является базой для всей китайской программы быстрых реакторов. Опыт его эксплуатации позволил перейти к проектированию и строительству демонстрационного CFR-600 в Сяпу.",
      "Реактор использует натриевый теплоноситель и способен работать в режиме воспроизводства ядерного топлива (бридер), превращая уран-238 в плутоний-239.",
      "CEFR расположен в пригороде Пекина (район Фаншань), что делает его единственной в мире атомной установкой такого типа в непосредственной близости от столицы многомиллионного государства (40 км от центра)."
    ]
  }

...
const stationsData = [
    ...
    },
    {
        ...
        units: [
            ...
            { id: 5, name: "Белоярская-5", type: "fast", model: "БН-1200М", capacity: 1220, status: "construction", startYear: 2035 }
        ],
        history: [
            ...
            { year: "2026", title: "НОВЫЙ РЕАКТОР НА 1200 МЕГАВАТТ", description: "Начало строительства энергоблока БН-1200М" }
        ],
        facts: [
...
},
{
  ...
  },
  {
    ...
    id: 1001,
    name: "АЭС Хурагуа",
    country: { name: "Куба", flag: "🇨🇺" },
    coords: [22.0662, -80.5078],
    status: "abandoned",
    totalCapacity: 880,
    startYear: 1983,
    overview: "Заброшенная атомная электростанция на Кубе, строившаяся по советскому проекту. Строительство окончательно прекращено в 2000 году. На момент остановки в 1992 году готовность первого блока составляла 95-97%, второй блок был готов на 25-30%. Единственная советская АЭС, строившаяся в Западном полушарии и тропическом климате.",
    ...
    history: [
        ...
        { year: "1983", title: "НАЧАЛО СТРОИТЕЛЬСТВА", description: "Начало строительства первого энергоблока АЭС Хурагуа" },
        { year: "1985", title: "СТРОИТЕЛЬСТВО ВТОРОГО БЛОКА", description: "Начало строительства второго энергоблока" },
        { year: "1992", title: "ПРИОСТАНОВКА СТРОИТЕЛЬСТВА", description: "5 сентября Фидель Кастро объявляет о приостановке строительства из-за финансовых трудностей после распада СССР" },
        { year: "2000", title: "ОКОНЧАТЕЛЬНЫЙ ОТКАЗ", description: "Куба и Россия официально отказываются от завершения проекта. Станция окончательно заброшена" }
    ],
    facts: [
        "Единственная советская АЭС, строившаяся в Западном полушарии и в тропическом климате",
        "Готовность первого энергоблока на момент остановки в 1992 году составляла 95-97%, второго — 25-30%",
        "При успешном завершении первый блок покрыл бы более 15% потребностей Кубы в электроэнергии",
        "Рядом с АЭС был построен городок для рабочих — Сьюдад-Нуклеар, многие здания которого остались недостроенными и заброшенными",
        "США выступали против строительства станции из-за её расположения всего в 288 км от побережья Флориды",
        "Официальный статус станции — 'abandoned', строительство окончательно прекращено в 2000 году"
    ]
}
